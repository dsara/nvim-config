return {
  -- Cmdline and notificaton replacement
  {
    'folke/noice.nvim',
    event = 'VeryLazy',
    opts = {},
    dependencies = {
      ...
      -- Optional; add in if you want to override notificatons
      -- Also update lualine with items you don't want to be notificaton
